...
const navItems = [
  { href: "/asesor-inicial", label: "Asesor Inicial" },
  { href: "/hoja-de-ruta", label: "Hoja de Ruta" },
  { href: "/empresa", label: "Empresa" },
  { href: "/documentos", label: "Documentos" },
  { href: "/libro-de-caja", label: "Libro de Caja" },
  { href: "/acciones-ia", label: "Acciones IA" },
  ...
  return (
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col h-screen sticky top-0">
      <div className="p-6 border-b border-gray-200">
        ...
        <p className="text-xs text-gray-500 mt-1">MVP Fase 3C</p>
      </div>
