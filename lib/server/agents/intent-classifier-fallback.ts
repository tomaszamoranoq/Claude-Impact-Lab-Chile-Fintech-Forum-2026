...
const DOMAIN_SCORERS: DomainScorer[] = [
  ...
  },
  {
    ...
    keywords: [
      ...
      { word: "no puedo pagar", weight: 3 }, { word: "no pago", weight: 3 }, { word: "no pagar", weight: 3 },
      { word: "impuestos atrasados", weight: 3 }, { word: "impuesto atrasado", weight: 3 },
      { word: "atrasado", weight: 2 }, { word: "atrasada", weight: 2 },
      { word: "cobranza", weight: 3 },
      { word: "tesorería", weight: 3 }, { word: "tesoreria", weight: 3 },
      { word: "abandonar", weight: 2 },
    ],
    strongSignals: ["cerrar", "cierre", "cerré", "disolver", "disolución", "liquidación de empresa", "liquidación empresa", "liquidación sociedad", "quiebra", "insolvencia", "termino de giro", "término de giro", "inactiva", "inactivo", "regularizar", "moroso", "embargo", "demanda", "no puedo pagar", "no pago", "no pagar", "impuestos atrasados", "impuesto atrasado", "atrasado", "atrasada", "cobranza", "tesorería", "tesoreria"],
